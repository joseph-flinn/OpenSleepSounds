...
export default function PlayCircle(props: SVGProps<SVGSVGElement>) {
  return (
    <svg 
    ...
    >
      <g fill="currentColor" fillRule="evenodd" clipRule="evenodd">
        <path d="m9 18.321l9.014-4.883L9 7.804zm9.49-4.003a1 1 0 0 0 .054-1.728L9.53 6.956A1 1 0 0 0 8 7.804v10.517a1 1 0 0 0 1.476.88z"></path>
